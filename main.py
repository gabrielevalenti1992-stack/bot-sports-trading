...
def get_fire_suffix(delta, metric_name):
    """Restituisce 🔥 o 🔥🔥 in base all'incremento."""
...
def should_notify_live(fixture_id, stats, minute):
    """Determina se inviare notifica live in base alle regole."""
...
if __name__ == '__main__':
    init_persistence()
    print("Bot avviato. Preferiti:", favorite_matches)
    print("Silenziati:", list(silenced_matches.keys()))
